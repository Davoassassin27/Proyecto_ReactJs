...
import Menu from "../spinner/Menu";
import Cerrar from "../imagenes/cerrar.png";
import Carrito from "../spinner/Carrito";
    ...
    <nav className={claseDeNav}>
      ...
      <section className={`opciones ${mostrarNav}`} id="opciones">
        <button
          ...
          onClick={() => setMostrarNav("esconderNav")}
        >
        ...
        <ul className="opcionesNavegacion">
          ...
          <li className="opcionNavegacion">
            ...
            <ul onClick={() => setMostrarNav("esconderNav")}>
              ...
              <li>
                <NavLink to="/category/Rugby">Rugby</NavLink>
              </li>
              <li>
                <NavLink to="/category/Basquetball">Basquetball</NavLink>
              </li>
            </ul>
          </li>
          <li className="opcionNavegacion">
            ...
            <ul onClick={() => setMostrarNav("esconderNav")}>
              <li>
                <NavLink to="/category/Camiseta">Camisetas</NavLink>
              </li>
              <li>
                <NavLink to="/category/Shorts">Shorts</NavLink>
              </li>
              <li>
                <NavLink to="/category/Conjunto">Conjuntos</NavLink>
              </li>
              <li>
